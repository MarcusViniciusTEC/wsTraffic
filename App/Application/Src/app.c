...
static void traffic_data(void)
{
    ...
    vehicle_data[VEHICLES_CLASS_35D].vehicle_axles[AXLE_1] = 1;
    vehicle_data[VEHICLES_CLASS_35D].vehicle_axles[AXLE_2] = 11;
    vehicle_data[VEHICLES_CLASS_35D].vehicle_axles[AXLE_3] = 16;
    vehicle_data[VEHICLES_CLASS_35D].vehicle_axles[AXLE_4] = 40;
    vehicle_data[VEHICLES_CLASS_35D].vehicle_axles[AXLE_5] = 63;
    vehicle_data[VEHICLES_CLASS_35D].vehicle_axles[AXLE_6] = 68;
    vehicle_data[VEHICLES_CLASS_35D].vehicle_axles[AXLE_7] = 91;
    vehicle_data[VEHICLES_CLASS_35D].vehicle_axles[AXLE_8] = 96;

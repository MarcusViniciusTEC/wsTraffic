...
loop_status_update_t transit_state_group_loop_1(uint16_t time_between_loops_t, uint16_t gap_t, uint16_t time_spent_in_the_bonds_t, uint16_t time_start_piezo_t, uint8_t group_index);
